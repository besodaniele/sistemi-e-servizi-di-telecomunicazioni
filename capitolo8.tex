...
\begin{itemize}
	\item \textbf{Location area più grandi}: più signaling causato dal paging, meno signaling causato dal location update.
	\item \textbf{Location area più piccole}: meno signaling causato dal paging, più signaling causato dal location update.
\end{itemize}
...
Si può avere dimensioni di cluster uguale a uno se si utilizzano frequenze ortogonali o codici ortogonali, queste tecniche sono usate in 3G, 4G e 5G rendendo inutile la pianificazione delle frequenze.
...
Questo porta a dover ri-effettuare la pianificazione di copertura.
\begin{figure}[H]
	\centering
