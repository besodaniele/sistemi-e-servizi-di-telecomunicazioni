...
Il token bucket preserva la burstiness del traffico.
...
\section{Scheduling}
Le tecniche di scheduling permettono di partizionare le interfacce di uscita del router tra i vari flussi di traffico.
