...
\begin{itemize}
	\item \textbf{Wirelless Local Area Networks (WLAN) e Fixed Wireless Access (FWA)}: 
	\begin{itemize}
...
Se voglio separare downlink e upling sullo stesso medium di trasmissione, posso utilizzare tecniche di duplexing:
\begin{itemize}
