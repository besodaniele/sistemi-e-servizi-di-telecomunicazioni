...
Inoltre, viene introdotto il concetto di bearer service.
\begin{figure}[H]
	\centering
...
\begin{itemize}
	\item Bitrate massimo
	\item Bitrate minimo garantito
	\item Delay massimo
...
\begin{itemize}
	\item Core Network (CN) bearer service: tra i nodi della core network (SGSN e GGSN)
