...
Così facendo, si crea un circuito virtuale tra la sorgente e la destinazione (provider edge routers).
...
\begin{itemize}
	...
	\item Prenotare, rilasciare e ri-allocare risorse.
	\item Evitare cicli.
\end{itemize}
...
Lo spazio di indirizzamento è quindi condiviso tra i vari siti.
