...
\begin{itemize}
	...
	\item \textbf{Gateway MSC (GMSC)}: MSC connesso alla PTSN o altre reti radiomobili, implementa funzioni di signaling inter-rete.
...
\begin{enumerate}
	...
	\end{figure}
	\item Il MSC attiva la procedura di pagina usando il TMSI ottenuto dal VLR. In questo modo identifica la LA attualmente visitata dalla MS (il LAI è memorizzato nel VLR assieme al TMSI).
